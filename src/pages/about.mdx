...
I have a template in my DAW where I use Logic's I/O plugin to put the pedal between the interface input and an amp simulation (currently: [Mixwave's Benson Chimera Plugin\*](https://sweetwater.sjv.io/B0N2PL)).
