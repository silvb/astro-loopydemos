...
#### The Lo-Fi Preamp: JHS Pedals 424 Gain Stage

<DemoWidget presetSlug="jhs-pedals-424-gain-stage" />

The 424 Gain Stage takes a completely different approach to drive—it's **not an overdrive at all**, but rather a faithful recreation of the **Tascam 424 multitrack cassette recorder's preamp circuit**. This pedal captures that distinctive **lo-fi, elastic character** that defines artists like Mk.gee, Steve Lacy, and the modern bedroom pop sound.

Unlike traditional drives that add distortion, the 424 provides **authentic cassette saturation** and **dynamic compression** that responds beautifully to your playing touch. Light picking delivers those characteristic **compressed, tape-saturated cleans**, while harder playing pushes it into wonderfully **smashed-out territory**. The **dual gain structure** (Gain 1 and Gain 2) works with the volume control to dial in everything from sparkly clean boost to saturated lo-fi textures.

What makes it perfect for bedroom pop is the **balanced XLR output**—you can run it direct to your interface just like the original Portastudio workflow, capturing that **authentic bedroom recording character** that no amp simulation can replicate. It's the secret to getting those rubbery, compressed tones that sit perfectly in lo-fi and dream pop contexts.

**Key features:**

- Faithful Tascam 424 preamp circuit recreation with original op-amps
- Dual gain structure for clean boost to lo-fi saturation
- Balanced XLR output for direct recording applications  
- Incredibly responsive to playing dynamics and guitar volume

<PartnerLinks slug="jhs-pedals-424-gain-stage" />
