...
type: post
slug: best-all-in-one-shoegaze-pedals
date: 2024-01-09
pedalImages:
  - ../../images/walrus-audio-melee.webp
  - ../../images/beautiful-noise-effects-when-the-sun-explodes.png
  - ../../images/old-blood-noise-endeavors-screen-violence.png
tags:
  - shoegaze
  - distortion + reverb
  - wall of sound
...
coverImage: ../../images/best-all-in-one-shoegaze-pedals.png
ogImage: ../../images/seo-preview/best-all-in-one-shoegaze-pedals.jpeg
---

import { MeleeDemo } from './melee-demo'
import { ScreenViolenceDemo } from './screen-violence-demo'
import { WhenTheSunExplodesDemo } from './when-the-sun-explodes-demo'
...
- Snag one from [Perfect Circuit\*](https://link.perfectcircuit.com/t/v1/8-12626-329078-9759?url=https%3A%2F%2Fwww.perfectcircuit.com%2Fwalrus-melee.html)
...
- If you're in the US, grab it from [Sound Shoppe](https://soundshoppe.nyc/products/when-the-sun-explodes)
